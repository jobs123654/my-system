...
<body>
	...
	<div class="header-bottom">
     ...
     <div class="clear"></div>
        ...
        <div class="login" style="background:  url('img/bg.jpg') repeat;">
          	<div class="wrap"style="padding-left: 30%">
				...
				<div class="login-title" >
					...
					<div id="loginbox" class="loginbox" >
						<form action="mlogin" method="post" name="login" id="login-form">
						  <fieldset class="input">
						    <p id="login-form-username">
						      <label for="modlgn_username">账号</label>
						    ...
						    <div class="remember">
							    ...
							    <input type="submit"  class="button" value="登录"><div class="clear"></div>
							 </div>
						  </fieldset>
						 </form>
						  <p>
