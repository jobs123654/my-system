...
<body>
     <div class="header-top">
         ...
         <form class="search" action="result_user_list" method="post">	  
			 ...
			 <div class="cssmenu">
				<ul>
					...
					欢迎回来, <c:out value="${user.name}"></c:out>
					</a></li>|
	  ...
	  <label style="margin-left: 5%">  <a href="home">首页</a>/账户列表</label>
	  <label style="margin-left: 80%">  <a title="添加账户" href="add_manager">+</a></label>
	 </div>
		 <hr>
           	 ...
           	 <tr>
           	 	...
           	 	<td>
           	 	  <c:out value="${ i.time}"></c:out>
           	 		...
           	 		<td>
           	 	   <a href="delete_manager?id=<c:out value="${ i.id}"></c:out>">&times</a>
           	 	</td>
           	 	</td>
           	 		<td>
           	 	   <a href="update_manager?id=<c:out value="${ i.id}"></c:out>">/</a>
           	 	</td>
           	 </tr>
           	 </c:forEach>
           </tbody>
